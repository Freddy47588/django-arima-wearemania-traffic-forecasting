...
# Set Path Kredensial
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = os.path.join(settings.BASE_DIR, 'ga4_credentials.json')
...
def sync_ga4_to_db(property_id, days_back=30):
    ...
    for row in response.rows:
        ...
        if 'arema-fc' in path:
            ...
            continue # Abaikan path yang tidak relevan (seperti /admin/ atau /login/)
